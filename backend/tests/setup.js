...
const { hashPassword, createToken, createRefreshToken, verifyToken, verifyRefreshToken } = require('../utils/crypto');
...
function createTestUser(overrides = {}) {
  ...
  const refreshToken = createRefreshToken(result.lastInsertRowid);
  return { id: result.lastInsertRowid, email, name, password, token, refreshToken };
}
...
module.exports = {
  app, db, hashPassword, createToken, createRefreshToken, verifyToken, verifyRefreshToken,
