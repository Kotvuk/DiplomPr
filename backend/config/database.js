...
try { db.exec('ALTER TABLE trades ADD COLUMN entry_amount REAL'); } catch(e) {}
try { db.exec('ALTER TABLE trades ADD COLUMN user_id INTEGER REFERENCES users(id)'); } catch(e) {}
try { db.exec('ALTER TABLE alerts ADD COLUMN user_id INTEGER REFERENCES users(id)'); } catch(e) {}
try { db.exec('ALTER TABLE watchlist ADD COLUMN user_id INTEGER REFERENCES users(id)'); } catch(e) {}
